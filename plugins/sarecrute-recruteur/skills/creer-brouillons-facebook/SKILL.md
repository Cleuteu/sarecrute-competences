...
- sinon, lui dire en deux lignes que la compétence n'a pas pu démarrer et qu'un mail pour Alex est
  ...
  `[SaRecrute] Échec creer-brouillons-facebook (snapshot) — <JJ/MM/AAAA HH:MM>`, corps = la ligne `ÉCHEC` exacte, la
...
ligne avant de commencer — une seule ligne, `creer-brouillons-facebook <version>`, rien d'autre : ce qui
